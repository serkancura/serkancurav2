...
import com.serkancura.serkancura.constant.Const;
...
public class Home extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.nav_about_us:
                ...
                intent.putExtra(PAGE_URL, Const.pages.replace("PAGE_ID","364"));
            ...
            case R.id.nav_website:
                startActivity(new Intent(Intent.ACTION_VIEW,Uri.parse("http://www.serkancura.com")));
                break;
        }
    ...
    public static Intent openFacebook(Context context){
        try {
            ...
            return new Intent(Intent.ACTION_VIEW, Uri.parse("fb://page/474535246066389"));
        } catch (Exception e){
            return new Intent(Intent.ACTION_VIEW,Uri.parse("https://facebook.com/serkancura"));
        }
    }
    ...
    public static Intent openYoutube(Context context){
        try {
            ...
            return new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/channel/UC--PcuhfXoiLz04BJViqbpQ"));
        } catch (Exception e){
            return new Intent(Intent.ACTION_VIEW,Uri.parse("https://www.youtube.com/channel/UC--PcuhfXoiLz04BJViqbpQ"));
        }
    }

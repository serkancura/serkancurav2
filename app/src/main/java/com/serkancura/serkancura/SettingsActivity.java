    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.llTermsAndConditions:
                ...
                intent1.putExtra(PAGE_TITLE,"Hakkımızda");
                intent1.putExtra(PAGE_URL, Const.pages.replace("PAGE_ID","364"));
                startActivity(intent1);
                break;
            case R.id.llPrivacyPolicy:
                Intent intent2 = new Intent(SettingsActivity.this,SitePageLoader.class);
                intent2.putExtra(PAGE_TITLE,"Gizlilik");
                intent2.putExtra(PAGE_URL, Const.pages.replace("PAGE_ID","5691"));
                startActivity(intent2);
                break;
            case R.id.llReportAnIssue:
                Intent intent3 = new Intent(SettingsActivity.this,SitePageLoader.class);
                intent3.putExtra(PAGE_TITLE,"İletişim");
                intent3.putExtra(PAGE_URL, Const.pages.replace("PAGE_ID","157"));

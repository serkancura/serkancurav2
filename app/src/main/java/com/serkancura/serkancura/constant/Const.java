...
public class Const {
    ...
    public static final String url = "https://www.serkancura.com/wp-json/wp/v2/posts/?filter[category_name]=android&per_page=10&fields=id,date,link,title,better_featured_image";
